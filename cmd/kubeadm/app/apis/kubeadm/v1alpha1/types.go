...
type MasterConfiguration struct {
	...
	// Container registry for non-core container images (pause, kube-dns, etcd...)
	// By default, same as ImageRepository
	NonCoreImageRepository string `json:"nonCoreImageRepository"`

	// Container registory for core container images generated by CI
	CIImageRepository string `json:"ciImageRepository"`

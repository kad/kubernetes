...
const (
	...
	// Role defined in default 1.8 RBAC policies for automatic CSR approvals for automatically rotated node certificates
...
func AutoApproveNodeCertificateRotation(client clientset.Interface, k8sVersion *version.Version) error {
	...
	// Create autorotation cluset role binding only if we deploying or upgrading to version that supports it.
